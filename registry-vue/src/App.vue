...
.prose ol li::before {
  ...
  font-weight: 400;
  color: hsl(var(--teal-dark-hsl), 1);
  border: 1px solid hsl(var(--teal-hsl), 1);
  background-color: hsl(var(--white-hsl), 1);
  padding: 2px 0;
  border-radius: 50%;
  height: 32px;
...
.prose ul li:before {
  ...
  width: 10px;
  height: 10px;
  border-left: 6px solid hsl(var(--teal-hsl), 1);
...
.category:hover {
  ...
  background: linear-gradient(
    90deg,
    hsl(var(--base-hsl), 0) 0%,
    hsl(var(--base-hsl), 0.1) 100%
  );
}
.category--active {
  background-color: hsl(var(--teal-hsl), 0.1);
  background: linear-gradient(
    90deg,
    hsl(var(--teal-hsl), 0) 0%,
    hsl(var(--base-hsl), 0.3) 100%
  );
}
...
.sidebar-list__item.sidebar-list--expanded
  > .sidebar-list__trigger
  > .material-icons {
  transform: rotate(45deg);
}
